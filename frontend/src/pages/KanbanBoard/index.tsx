...
const KanbanBoard = () => {
    ...
    const [reorderList, setReorderList] = useState<{ id: number; order: number }[]>([]);
        ...
        >
            <div className="h-[calc(100vh-64px)] flex flex-col bg-background">
                <KanbanHeader
                    ...
                    activeFiltersCount={Object.values(columnSettings).reduce((count, settings) => {
                        return (
                            count +
                ...
                <ColumnModals
                    ...
                    onCreateColumn={() => {
                        ...
                        if (
                            newColumnLabelOption === "existing" &&
                            !newColumnLabelId &&
                            !newColumnLabelName.trim()
                        ) {
                            setErrorMessage({
                                message: "Please select an existing label or enter a label name.",
                                target: "newLabel",
                            });
                            return;
                        }
                        ...
                        if (newColumnLabelOption === "new" && !newColumnLabelName.trim()) {
                            setErrorMessage({
                                message: "Please enter a name for the new label.",
                                target: "newLabel",
                            });
                            return;
                        }
                        ...
                        createColumn(
                            {
                                ...
                                existingLabelName:
                                    newColumnLabelOption === "existing"
                                        ...
                                        : undefined,
                                newLabelName:
                                    newColumnLabelOption === "new" ? newColumnLabelName : undefined,
                            },
                            {
                                onSuccess: () => {
                                    queryClient.invalidateQueries({
                                ...
                                dto: {
                                    ...
                                    existingLabelName:
                                        assignLabelOption === "existing"
                                            ...
                                            : undefined,
                                    newLabelName:
                                        assignLabelOption === "new" ? assignLabelName : undefined,
                                },
                            },
                            {
                                onSuccess: () => {
